...
insert into categories(name, created_at) values ('Gay'     , now());
...
insert into products(category_id, name, description, price, created_at) values (1, 'Mundo Estranho', 'Como é o comportamento do Danilo',  9, now());
insert into products(category_id, name, description, price, created_at) values (1, 'Mundo Estranho', 'Como é o comportamento do Johalf',  8, now());
insert into products(category_id, name, description, price, created_at) values (1, 'Mundo Estranho', 'Como é o comportamento do Eurico',  8, now());
insert into products(category_id, name, description, price, created_at) values (1, 'Mundo Estranho', 'Como é o comportamento do B2',  8, now());
...
insert into products(category_id, name, description, price, created_at) values (2, 'Aprenda Ruby em 21 dias', '300 páginas sobre ruby para você aprender.' , 59, now());
...
insert into products(category_id, name, description, price, created_at) values (4, 'Danilo'  , 'Todo dia, toda hora', 3, now());
insert into products(category_id, name, description, price, created_at) values (4, 'Eurico'  , 'Todo dia, toda hora', 3, now());
insert into products(category_id, name, description, price, created_at) values (4, 'Johalf'  , 'Todo dia, toda hora', 3, now());
